...
RankeDB addresses this gap through a structural inversion: the provenance DAG is the system, and everything else — including the semantic knowledge graph — is a view derived from it. This paper describes the architecture, its invariants, and its properties.
